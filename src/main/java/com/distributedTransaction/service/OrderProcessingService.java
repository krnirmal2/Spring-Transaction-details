...
public class OrderProcessingService {
    ...
    public Order placeAnOrder(Order order) {
        ...
        // Step 2 : validate stock availability <(5)
...
//        getCustomerDetails();
    ...
    private void updateInventoryStock(Order order, Product product) {// total stock minus user order
